...
/**
 * SVG Sprite Component - Centralized icon definitions
 * Include this component once in app.ts to make all icons available globally
 * Reference icons using: <svg class="icon"><use href="#icon-name"></use></svg>
 */
@Component({
  ...
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      <defs>
        ...
        <symbol id="icon-experience" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="2" y="7" width="20" height="14" rx="2"/>
          <path d="M16 3v4M8 3v4"/>
          <path d="M2 11h20"/>
        </symbol>
        
        <symbol id="icon-projects" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <symbol id="icon-articles" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <symbol id="icon-contact" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
